...
for k,v in pairs( Srealweaponsshop ) do 
if table.HasValue(weapons.GetStored(v.name).CanBuy, ROLE_SURVIVALIST)then
else
table.insert(weapons.GetStored(v.name).CanBuy, ROLE_SURVIVALIST )
end
end

for k,v in pairs( Drealweaponsshop ) do 
if table.HasValue(weapons.GetStored(v.name).CanBuy, ROLE_DETECTIVE)then
else
table.insert(weapons.GetStored(v.name).CanBuy, ROLE_DETECTIVE )
end
end

for k,v in pairs( Trealweaponsshop ) do 
if table.HasValue(weapons.GetStored(v.name).CanBuy, ROLE_TRAITOR)then
else
table.insert(weapons.GetStored(v.name).CanBuy, ROLE_TRAITOR )
end
end

for k,v in pairs( SKrealweaponsshop ) do 
if table.HasValue(weapons.GetStored(v.name).CanBuy, ROLE_SERIALKILLER)then
else
table.insert(weapons.GetStored(v.name).CanBuy, ROLE_SERIALKILLER )
end
end
