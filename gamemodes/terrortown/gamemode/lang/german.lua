...
L.survivalist  = "Überlebenskünstler"
L.jester  = "Narr"
L.resurrector  = "Phönix"
...
L.body_found_s     = "Er war ein Überlebenskünstler."
L.body_found_j     = "Er war ein Narr."
L.body_found_r     = "Er war ein Phönix."
...
L.search_role_s = "Diese Person war ein Überlebenskünstler."
L.search_role_j = "Dieser Person war ein Narr."
L.search_role_r = "Diese Person war ein Phönix."
...
L.info_popup_survivalist = [[Du bist ein Überlebenskünstler! 
Hilf deinen unschuldigen Freunden!
Lass dich nicht mit den Verrätern verwechseln.

Drücke {menukey} für neue Ausrüstung!]]

L.info_popup_jester = [[Du bist ein Narr! Du hasst dein Leben, aber du verursachst keinen Schaden. Daher muss dich jemand anders töten.]]

L.info_popup_phoenix = [[Du bist ein Phönix! Du kannst wieder zum Leben erwachen, wenn du durch Schaden unter 25 stirbst. (Du kannst immer noch durch einen Schuss sterben.)]]
