...
local function RoleChatRecv()
   ...
   elseif role == ROLE_SURVIVALIST then
      chat.AddText(Color( 255, 132, 31 ),
                   Format("(%s) ", string.upper(GetTranslation("survivalist"))),
                   Color( 25, 200, 255),
                   sender:Nick(),
                   Color( 200, 255, 255),
                   ": " .. text)
   ...
   elseif role == ROLE_JESTER then
      chat.AddText(Color( 255, 105, 180 ),
   ...
   elseif role == ROLE_RESURRECTOR then
      chat.AddText(Color( 135, 206, 250 ),
                   Format("(%s) ", string.upper(GetTranslation("resurrector"))),
                   Color( 25, 200, 255),
                   sender:Nick(),
                   Color( 200, 255, 255),
                   ": " .. text)
