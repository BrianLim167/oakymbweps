...
function SCORE:HandleSelection()
   ...
   for k, ply in pairs(player.GetAll()) do
	  ...
	  elseif ply:GetSurvivalist() then
         table.insert(survivalists, ply:SteamID())
	  elseif ply:GetJester() then
         table.insert(jesters, ply:SteamID())
	  elseif ply:GetResurrector() then
         table.insert(resurrectors, ply:SteamID())
	  elseif ply:GetSerialkiller() then
         table.insert(serialkillers, ply:SteamID())
	  elseif ply:GetInfected() then
         table.insert(infecteds, ply:SteamID())
      end
   end
