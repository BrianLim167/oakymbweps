...
function HELPSCRN:Show()
   ...
   cb = dgui:NumSlider("Static crosshair gap", "ttt_crosshair_static_gap", 0, 0.02, 3)
   if cb.Label then
      cb.Label:SetWrap(true)
   end
   ...
   cb = dgui:CheckBox("Use static crosshair", "ttt_crosshair_static")
   cb:SetTooltip("Keeps crosshair from changing based on gun accuracy.")
