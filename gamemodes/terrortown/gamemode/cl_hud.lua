...
local bg_colors = {
   ...
   survivalist = Color(255, 102, 51, 200),
   jester = Color(255, 105, 180, 200),
   resurrector = Color(	135, 206, 250, 200),
   serialkiller = Color(	85,	26,	139, 255),
   infected = Color(	29,	33,	13, 255)
};
...
local function DrawBg(x, y, width, height, client)
   ...
   elseif client:GetSurvivalist() then
      col = bg_colors.survivalist
   elseif client:GetJester() then
      col = bg_colors.jester
   elseif client:GetResurrector() then
      col = bg_colors.resurrector
   elseif client:GetSerialkiller() then
      col = bg_colors.serialkiller
   elseif client:GetInfected() then
      col = bg_colors.infected
   end
