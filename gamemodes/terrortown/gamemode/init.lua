...
CreateConVar("ttt_survivalist_pct", "0.13", FCVAR_NOTIFY)
...
CreateConVar("ttt_serialkiller_min_players", "8")
CreateConVar("ttt_serialkiller_realmin_players", "8")

CreateConVar("ttt_infected_pct", "0.13", FCVAR_NOTIFY)
CreateConVar("ttt_infected_max", "1")
CreateConVar("ttt_infected_min_players", "8")
CreateConVar("ttt_infected_realmin_players", "8")
-- Traitor credits
...
CreateConVar("tweaponlimit", "5")
CreateConVar("sweaponlimit", "3")
CreateConVar("dweaponlimit", "3")
CreateConVar("skweaponlimit", "2")

CreateConVar("randomtraitorweaponson", "1")
CreateConVar("randomsurvivalistweaponson", "0")
CreateConVar("randomdetectiveweaponson", "0")
CreateConVar("randomserialkillerweaponson", "0")
...
util.AddNetworkString( "randomweaponshoper" )

 timer.Create( "Jestercommandupdate", 0.1, 0, function()
if file.Exists("rolecommands/jestericon.txt", "DATA") then
if file.Read("rolecommands/jestericon.txt", "DATA") == tostring(GetConVar("jestertraitor"):GetInt()) then
else
		file.Write( "rolecommands/" .. "jestericon.txt", GetConVar("jestertraitor"):GetInt() )
end
else
		file.CreateDir( "rolecommands" ) -- Create the directory
		file.Write( "rolecommands/" .. "jestericon.txt", GetConVar("jestertraitor"):GetInt() ) -- Write to .txt
end


if file.Exists("rolecommands/randomweaponson.txt", "DATA") then
if file.Read("rolecommands/randomweaponson.txt", "DATA") == tostring(GetConVar("weaponsrandom"):GetInt()) then
else
		file.Write( "rolecommands/" .. "randomweaponson.txt", GetConVar("weaponsrandom"):GetInt() )
end
else
		file.CreateDir( "rolecommands" ) -- Create the directory
		file.Write( "rolecommands/" .. "randomweaponson.txt", GetConVar("weaponsrandom"):GetInt() ) -- Write to .txt
end


if file.Exists("rolecommands/randomtraitorweaponson.txt", "DATA") then
if file.Read("rolecommands/randomtraitorweaponson.txt", "DATA") == tostring(GetConVar("randomtraitorweaponson"):GetInt()) then
else
		file.Write( "rolecommands/" .. "randomtraitorweaponson.txt", GetConVar("randomtraitorweaponson"):GetInt() )
end
else
		file.CreateDir( "rolecommands" ) -- Create the directory
		file.Write( "rolecommands/" .. "randomtraitorweaponson.txt", GetConVar("randomtraitorweaponson"):GetInt() ) -- Write to .txt
end


if file.Exists("rolecommands/randomsurvivalistweaponson.txt", "DATA") then
if file.Read("rolecommands/randomsurvivalistweaponson.txt", "DATA") == tostring(GetConVar("randomsurvivalistweaponson"):GetInt()) then
else
		file.Write( "rolecommands/" .. "randomsurvivalistweaponson.txt", GetConVar("randomsurvivalistweaponson"):GetInt() )
end
else
		file.CreateDir( "rolecommands" ) -- Create the directory
		file.Write( "rolecommands/" .. "randomsurvivalistweaponson.txt", GetConVar("randomsurvivalistweaponson"):GetInt() ) -- Write to .txt
end


if file.Exists("rolecommands/randomdetectiveweaponson.txt", "DATA") then
if file.Read("rolecommands/randomdetectiveweaponson.txt", "DATA") == tostring(GetConVar("randomdetectiveweaponson"):GetInt()) then
else
		file.Write( "rolecommands/" .. "randomdetectiveweaponson.txt", GetConVar("randomdetectiveweaponson"):GetInt() )
end
else
		file.CreateDir( "rolecommands" ) -- Create the directory
		file.Write( "rolecommands/" .. "randomdetectiveweaponson.txt", GetConVar("randomdetectiveweaponson"):GetInt() ) -- Write to .txt
end

 
if file.Exists("rolecommands/randomserialkillerweaponson.txt", "DATA") then
if file.Read("rolecommands/randomserialkillerweaponson.txt", "DATA") == tostring(GetConVar("randomserialkillerweaponson"):GetInt()) then
else
		file.Write( "rolecommands/" .. "randomserialkillerweaponson.txt", GetConVar("randomserialkillerweaponson"):GetInt() )
end
else
		file.CreateDir( "rolecommands" ) -- Create the directory
		file.Write( "rolecommands/" .. "randomserialkillerweaponson.txt", GetConVar("randomserialkillerweaponson"):GetInt() ) -- Write to .txt
end

local randomweapondamn = file.Read("rolecommands/randomweaponson.txt", "DATA" )
local Trandomweapondamn = file.Read("rolecommands/randomtraitorweaponson.txt", "DATA" )
local Srandomweapondamn = file.Read("rolecommands/randomsurvivalistweaponson.txt", "DATA" )
local Drandomweapondamn = file.Read("rolecommands/randomdetectiveweaponson.txt", "DATA" )
local SKrandomweapondamn = file.Read("rolecommands/randomserialkillerweaponson.txt", "DATA" )
		 net.Start( "randomweaponshoper" )
		 net.WriteString(randomweapondamn)
		 net.WriteString(Trandomweapondamn)
		 net.WriteString(Srandomweapondamn)
		 net.WriteString(Drandomweapondamn)
		 net.WriteString(SKrandomweapondamn)
		 net.Broadcast()
...
if file.Exists("rolecommands/Jesterwinsates.txt", "DATA") then
else
 		local tab = util.TableToJSON( Players ) -- Convert the player table to JSON
		file.CreateDir( "rolecommands" ) -- Create the directory
		file.Write( "rolecommands/Jesterwinsates.txt", tab ) -- Write to .txt
end

local penisPlayers = {"Infected","Serialkiller","Jester"}
if file.Exists("rolecommands/randomroleround.txt", "DATA") then
else
 		local tab = util.TableToJSON( penisPlayers ) -- Convert the player table to JSON
		file.CreateDir( "rolecommands" ) -- Create the directory
		file.Write( "rolecommands/randomroleround.txt", tab ) -- Write to .txt
end

local weaponsmantraitorsMax = {}
local weaponsmansurvivalistMax = {}
local weaponsmandetectiveMax = {}
local weaponsmanserialkillerMax = {} 

for k, v in pairs(weapons.GetList()) do
if v and v.CanBuy then
if table.HasValue(weapons.GetStored(v.ClassName).CanBuy, ROLE_TRAITOR)then
table.insert( weaponsmantraitorsMax, v.ClassName )
else
end
end
end
...
for k, v in pairs(weapons.GetList()) do
if v and v.CanBuy then
if table.HasValue(weapons.GetStored(v.ClassName).CanBuy, ROLE_SURVIVALIST)then
table.insert( weaponsmansurvivalistMax, v.ClassName )
else
end
end
end
...
for k, v in pairs(weapons.GetList()) do
if v and v.CanBuy then
if table.HasValue(weapons.GetStored(v.ClassName).CanBuy, ROLE_DETECTIVE)then
table.insert( weaponsmandetectiveMax, v.ClassName )
else
end
end
end
...
for k, v in pairs(weapons.GetList()) do
if v and v.CanBuy then
if table.HasValue(weapons.GetStored(v.ClassName).CanBuy, ROLE_SERIALKILLER)then
table.insert( weaponsmanserialkillerMax, v.ClassName )
else
end
end
end

local Sfiles, Sdirectories = file.Find( "roleweapons/Survivalist/*.txt", "DATA" )
...
local SKfiles, SKdirectories = file.Find( "roleweapons/SerialKiller/*.txt", "DATA" )
...
Tplayers = util.JSONToTable(file.Read( "roleweapons/Traitor/" .. v, "DATA" ))

for k, v in pairs(Tplayers) do
table.insert( weaponsmantraitorsMax, v.name )
end
end

for k,v in pairs( Sfiles ) do 
Splayers = util.JSONToTable(file.Read( "roleweapons/Survivalist/" .. v, "DATA" ))

for k, v in pairs(Splayers) do
table.insert( weaponsmansurvivalistMax, v.name )
end
end

for k,v in pairs( Dfiles ) do 
Dplayers = util.JSONToTable(file.Read( "roleweapons/Detective/" .. v, "DATA" ))

for k, v in pairs(Dplayers) do
table.insert( weaponsmandetectiveMax, v.name )
end
end

for k,v in pairs( SKfiles ) do 
SKplayers = util.JSONToTable(file.Read( "roleweapons/SerialKiller/" .. v, "DATA" ))

for k, v in pairs(SKplayers) do
table.insert( weaponsmanserialkillerMax, v.name )
end
end

local maxtraitordelete = tonumber(GetConVar("tweaponlimit"):GetInt())
local maxsurvivalistdelete = tonumber(GetConVar("sweaponlimit"):GetInt())
local maxdetectivedelete = tonumber(GetConVar("dweaponlimit"):GetInt())
local maxserialkillerdelete = tonumber(GetConVar("skweaponlimit"):GetInt())

local weaponsmantraitors = {}
local weaponsmansurvivalist = {}
local weaponsmandetective = {}
local weaponsmanserialkiller = {}


for i=1,maxtraitordelete do 
local deletetraitor = math.random( 1, table.Count( weaponsmantraitorsMax ) )
for k,v in pairs( weaponsmantraitorsMax ) do 
if k == deletetraitor then
table.insert(weaponsmantraitors, v )
table.remove( weaponsmantraitorsMax, k )
end
end
end

for i=1,maxsurvivalistdelete do 
local deletesurvivalist = math.random( 1, table.Count( weaponsmansurvivalistMax ) )
for k,v in pairs( weaponsmansurvivalistMax ) do 
if k == deletesurvivalist then
table.insert(weaponsmansurvivalist, v )
table.remove( weaponsmansurvivalistMax, k )
end
end
end

for i=1,maxdetectivedelete do 
local deletedetective = math.random( 1, table.Count( weaponsmandetectiveMax ) )
for k,v in pairs( weaponsmandetectiveMax ) do 
if k == deletedetective then
table.insert(weaponsmandetective, v )
table.remove( weaponsmandetectiveMax, k )
end
end
end

for i=1,maxserialkillerdelete do 
local deleteserialkiller = math.random( 1, table.Count( weaponsmanserialkillerMax ) )
for k,v in pairs( weaponsmanserialkillerMax ) do 
if k == deleteserialkiller then
table.insert(weaponsmanserialkiller, v )
table.remove( weaponsmanserialkillerMax, k )
end
end
end
...
if file.Exists("rolecommands/randomtraitorweapons.txt", "DATA") then
else
 		local tab = util.TableToJSON( weaponsmantraitors ) -- Convert the player table to JSON
		file.CreateDir( "rolecommands" ) -- Create the directory
		file.Write( "rolecommands/randomtraitorweapons.txt", tab ) -- Write to .txt
end

if file.Exists("rolecommands/randomsurvivalistweapons.txt", "DATA") then
else
 		local tab = util.TableToJSON( weaponsmansurvivalist ) -- Convert the player table to JSON
		file.CreateDir( "rolecommands" ) -- Create the directory
		file.Write( "rolecommands/randomsurvivalistweapons.txt", tab ) -- Write to .txt
end

if file.Exists("rolecommands/randomdetectiveweapons.txt", "DATA") then
else
 		local tab = util.TableToJSON( weaponsmandetective ) -- Convert the player table to JSON
		file.CreateDir( "rolecommands" ) -- Create the directory
		file.Write( "rolecommands/randomdetectiveweapons.txt", tab ) -- Write to .txt
end

if file.Exists("rolecommands/randomserialkillerweapons.txt", "DATA") then
else
 		local tab = util.TableToJSON( weaponsmanserialkiller ) -- Convert the player table to JSON
		file.CreateDir( "rolecommands" ) -- Create the directory
		file.Write( "rolecommands/randomserialkillerweapons.txt", tab ) -- Write to .txt
end


if file.Exists("rolecommands/randomweaponsrole.txt", "DATA") then
else
 		local randomtab = 3
		file.CreateDir( "rolecommands" ) -- Create the directory
		file.Write( "rolecommands/randomweaponsrole.txt", randomtab ) -- Write to .txt
end

table.insert( rolemapgotwo, 1, tostring(GetConVar("ttt_survivalist_realmin_players"):GetInt()) )
table.insert( rolemapgotwo, 2, tostring(GetConVar("ttt_jester_realmin_players"):GetInt()) )
table.insert( rolemapgotwo, 3, tostring(GetConVar("ttt_phoenix_realmin_players"):GetInt()) )
table.insert( rolemapgotwo, 4, tostring(GetConVar("ttt_serialkiller_realmin_players"):GetInt()) )
table.insert( rolemapgotwo, 5, tostring(GetConVar("ttt_infected_realmin_players"):GetInt()) )
...
hook.Add( "PlayerDeath", "OnPlayerDeath", function( victim, infl, attacker)
   if victim:GetJester() and attacker:IsPlayer() and infl:GetClass() ~= env_fire and not attacker:GetJester()  then
   if GetConVar("jesterwinstate"):GetInt() == 4 or GetConVar("jesterwinstate"):GetInt() == 5 then
   else
   jesterkilled = 1
   end
   end
...
local survivalistrandom = math.random( 1, GetConVar("ttt_randomnewroles_ran_survivalist"):GetInt() )
local jesterrrandom = math.random( 1, GetConVar("ttt_randomnewroles_ran_jester"):GetInt() )
local phoenixrandom = math.random( 1, GetConVar("ttt_randomnewroles_ran_phoenix"):GetInt() )
local serialkillerrandom = math.random( 1, GetConVar("ttt_randomnewroles_ran_serialkiller"):GetInt() )
local infectedrandom = math.random( 1, GetConVar("ttt_randomnewroles_ran_infected"):GetInt() )
...
for k, v in pairs( rolemapgotwo ) do
if k == 1 then
table.insert( rolemapgo, 1, v )
elseif k == 2 then
table.insert( rolemapgo, 2, v )
elseif k == 3 then
table.insert( rolemapgo, 3, v )
elseif k == 4 then
table.insert( rolemapgo, 4, v )
elseif k == 5 then
table.insert( rolemapgo, 5, v )
end
end

local Jwsplayers = util.JSONToTable(file.Read( "rolecommands/Jesterwinsates.txt", "DATA" ))

if GetConVar("jesterwinrandom"):GetInt() == 2 then
local randomnumberss = math.Round(math.random( 1, table.Count( Jwsplayers ) ))
for k,v in pairs( Jwsplayers ) do 
if k == randomnumberss then
RunConsoleCommand( "jesterwinstate", tostring(v) )
end
end 
end

local ranroles = util.JSONToTable(file.Read( "rolecommands/randomroleround.txt", "DATA" ))

if GetConVar("ttt_randomnewroles"):GetInt() <= 0 then
for k, v in pairs( rolemapgo ) do
if k == 1 then
RunConsoleCommand("ttt_survivalist_min_players", rolemapgo[1] )
elseif k == 2 then
RunConsoleCommand("ttt_jester_min_players", rolemapgo[2] )
elseif k == 3 then
RunConsoleCommand("ttt_phoenix_min_players", rolemapgo[3] )
elseif k == 4 then
RunConsoleCommand("ttt_serialkiller_min_players", rolemapgo[4] )
elseif k == 5 then
RunConsoleCommand("ttt_infected_min_players", rolemapgo[5] )
end
end
elseif GetConVar("ttt_randomnewroles"):GetInt() == 2 then
local randomrolesnumberss = math.Round(math.random( 1, table.Count( ranroles ) ))
for k,v in pairs( ranroles ) do 
if k == randomrolesnumberss then
print(v)
if v == "Jester" then
print("yes Jester")
RunConsoleCommand( "ttt_randomnewroles_jester", "0" )
RunConsoleCommand( "ttt_randomnewroles_serialkiller", "2" )
RunConsoleCommand( "ttt_randomnewroles_infected", "2" )
RunConsoleCommand("ttt_jester_min_players", rolemapgo[2] )
RunConsoleCommand("ttt_serialkiller_min_players", "999" )
RunConsoleCommand("ttt_infected_min_players", "999" )
elseif v == "Serialkiller" then
print("yes Serialkiller")
RunConsoleCommand( "ttt_randomnewroles_jester", "2" )
RunConsoleCommand( "ttt_randomnewroles_serialkiller", "0" )
RunConsoleCommand( "ttt_randomnewroles_infected", "2" )
RunConsoleCommand("ttt_jester_min_players", "999" )
RunConsoleCommand("ttt_serialkiller_min_players", rolemapgo[4] )
RunConsoleCommand("ttt_infected_min_players", "999" )
elseif v == "Infected" then
print("yes infected")
RunConsoleCommand( "ttt_randomnewroles_jester", "2" )
RunConsoleCommand( "ttt_randomnewroles_serialkiller", "2" )
RunConsoleCommand( "ttt_randomnewroles_infected", "0" )
RunConsoleCommand("ttt_jester_min_players", "999" )
RunConsoleCommand("ttt_serialkiller_min_players", "999" )
RunConsoleCommand("ttt_infected_min_players", rolemapgo[5] )
end
...
--survivalist
if survivalistrandom == 1 and GetConVar("ttt_randomnewroles_survivalist"):GetInt() == 1 then
RunConsoleCommand("ttt_survivalist_min_players", rolemapgo[1] )
print("Survivalist spawn")
elseif survivalistrandom >= 1 and GetConVar("ttt_randomnewroles_survivalist"):GetInt() >= 2 then
RunConsoleCommand("ttt_survivalist_min_players", "999" )
print("Survivalist not spawn")
elseif survivalistrandom >= 1 and GetConVar("ttt_randomnewroles_survivalist"):GetInt() == 0 then
RunConsoleCommand("ttt_survivalist_min_players", rolemapgo[1] )
print("Survivalist spawn")
elseif survivalistrandom >= 2 and GetConVar("ttt_randomnewroles_survivalist"):GetInt() >= 1 then
RunConsoleCommand("ttt_survivalist_min_players", "999" )
print("Survivalist not spawn")
end
--pheonix
if phoenixrandom == 1 and GetConVar("ttt_randomnewroles_phoenix"):GetInt() == 1 then
RunConsoleCommand("ttt_phoenix_min_players", rolemapgo[3] )
print("phoenix spawn")
elseif phoenixrandom >= 1 and GetConVar("ttt_randomnewroles_phoenix"):GetInt() >= 2 then
RunConsoleCommand("ttt_phoenix_min_players", "999" )
print("phoenix not spawn")
elseif phoenixrandom >= 1 and GetConVar("ttt_randomnewroles_phoenix"):GetInt() == 0 then
RunConsoleCommand("ttt_phoenix_min_players", rolemapgo[3] )
print("phoenix spawn")
elseif phoenixrandom >= 2 and GetConVar("ttt_randomnewroles_phoenix"):GetInt()>= 1 then
RunConsoleCommand("ttt_phoenix_min_players", "999" )
print("phoenix not spawn")
end

elseif GetConVar("ttt_randomnewroles"):GetInt() == 1 then
...
--jester
if jesterrrandom == 1 and GetConVar("ttt_randomnewroles_jester"):GetInt() == 1 then
RunConsoleCommand("ttt_jester_min_players", rolemapgo[2] )
print("jester spawn")
elseif jesterrrandom >= 1 and GetConVar("ttt_randomnewroles_jester"):GetInt() >= 2 then
RunConsoleCommand("ttt_jester_min_players", "999" )
print("jester not spawn")
elseif jesterrrandom >= 1 and GetConVar("ttt_randomnewroles_jester"):GetInt() == 0 then
RunConsoleCommand("ttt_jester_min_players", rolemapgo[2] )
print("jester spawn")
elseif jesterrrandom >= 2 and GetConVar("ttt_randomnewroles_jester"):GetInt() >= 1 then
RunConsoleCommand("ttt_jester_min_players", "999" )
print("jester not spawn")
end
--serialkiller
if serialkillerrandom == 1 and GetConVar("ttt_randomnewroles_serialkiller"):GetInt() == 1 then
RunConsoleCommand("ttt_serialkiller_min_players", rolemapgo[4] )
print("serialkiller spawn")
elseif serialkillerrandom >= 1 and GetConVar("ttt_randomnewroles_serialkiller"):GetInt() >= 2 then
RunConsoleCommand("ttt_serialkiller_min_players", "999" )
print("serialkiller not spawn")
elseif serialkillerrandom >= 1 and GetConVar("ttt_randomnewroles_serialkiller"):GetInt() == 0 then
RunConsoleCommand("ttt_serialkiller_min_players", rolemapgo[4] )
print("serialkiller spawn")
elseif serialkillerrandom >= 2 and GetConVar("ttt_randomnewroles_serialkiller"):GetInt() >= 1 then
RunConsoleCommand("ttt_serialkiller_min_players", "999" )
print("serialkiller not spawn")
end
--infected
if infectedrandom == 1 and GetConVar("ttt_randomnewroles_infected"):GetInt() == 1 then
RunConsoleCommand("ttt_infected_min_players", rolemapgo[5] )
print("infected spawn")
elseif infectedrandom >= 1 and GetConVar("ttt_randomnewroles_infected"):GetInt() >= 2 then
RunConsoleCommand("ttt_infected_min_players", "999" )
print("infected not spawn")
elseif infectedrandom >= 1 and GetConVar("ttt_randomnewroles_infected"):GetInt() == 0 then
RunConsoleCommand("ttt_infected_min_players", rolemapgo[5] )
print("infected spawn")
elseif infectedrandom >= 2 and GetConVar("ttt_randomnewroles_infected"):GetInt() >= 1 then
RunConsoleCommand("ttt_infected_min_players", "999" )
print("infected not spawn")
end

elseif GetConVar("ttt_randomnewroles"):GetInt() == 3 then

if infectedrandom == 1 and GetConVar("ttt_randomnewroles_infected"):GetInt() == 1 then
RunConsoleCommand("ttt_infected_min_players", rolemapgo[5] )
print("infected spawn")
RunConsoleCommand("ttt_infected_max", "32" )
RunConsoleCommand("ttt_traitor_min_players", "999" )
print("Traitors not spawn")
else
RunConsoleCommand("ttt_traitor_min_players", "1" )
print("Traitors spawn")
RunConsoleCommand("ttt_infected_max", "1" )
RunConsoleCommand("ttt_infected_min_players", "999" )
print("infected not spawn")
end
--survivalist
...
function TellTraitorsAboutTraitors()
   ...
   for k,v in pairs(player.GetAll()) do
      if v:IsTraitor() then
	if GetConVar("jestertraitor"):GetInt() == 1 then
	else
			if table.Count(jesternick) < 1 then
				v:PrintMessage( HUD_PRINTTALK, "There are no Jesters to worry about" )
			else
...
if GetConVar("jesterrandomcomments"):GetInt() == 2 then
if GetConVar("jesterwinrandom"):GetInt() == 2 then
if GetConVar("jesterwinstate"):GetInt() == 1 then
 	PrintMessage( HUD_PRINTCENTER, "When the Jester dies the round is over." )
	timer.Create( "Uniquejesterwinstate1", 2, 3, function() 
 	PrintMessage( HUD_PRINTCENTER, "When the Jester dies the round is over." )
	end )
 	PrintMessage( HUD_PRINTTALK, "When the Jester dies the round is over." )
elseif GetConVar("jesterwinstate"):GetInt() == 2 then
 	PrintMessage( HUD_PRINTCENTER, "When the Jester dies who killed him dies" )
	timer.Create( "Uniquejesterwinstate2", 2, 3, function() 
 	PrintMessage( HUD_PRINTCENTER, "When the Jester dies who killed him dies" )
	end )
 	PrintMessage( HUD_PRINTTALK, "When the Jester dies who killed him dies" )
elseif GetConVar("jesterwinstate"):GetInt() == 3 then
 	PrintMessage( HUD_PRINTCENTER, "When the Jester dies who killed him becomes a Jester" )
	timer.Create( "Uniquejesterwinstate3", 2, 3, function() 
 	PrintMessage( HUD_PRINTCENTER, "When the Jester dies who killed him becomes a Jester" )
	end )
 	PrintMessage( HUD_PRINTTALK, "When the Jester dies who killed him becomes a Jester" )
elseif GetConVar("jesterwinstate"):GetInt() == 4 then
 	PrintMessage( HUD_PRINTCENTER, "When the Jester dies who killed him dies but the Jester respawns with the Role of the person who killed him." )
	timer.Create( "Uniquejesterwinstate4", 2, 3, function() 
 	PrintMessage( HUD_PRINTCENTER, "When the Jester dies who killed him dies but the Jester respawns with the Role of the person who killed him." )
	end )
 	PrintMessage( HUD_PRINTTALK, "When the Jester dies who killed him dies but the Jester respawns with the Role of the person who killed him." )
elseif GetConVar("jesterwinstate"):GetInt() == 5 then
 	PrintMessage( HUD_PRINTCENTER, "When the Jester dies who killed him dies but the Jester respawns with the opposites Role of the person who killed him." )
	timer.Create( "Uniquejesterwinstate5", 2, 3, function() 
 	PrintMessage( HUD_PRINTCENTER, "When the Jester dies who killed him dies but the Jester respawns with the opposites Role of the person who killed him." )
	end )
 	PrintMessage( HUD_PRINTTALK, "When the Jester dies who killed him dies but the Jester respawns with the opposites Role of the person who killed him." )
elseif GetConVar("jesterwinstate"):GetInt() == 6 then
 	PrintMessage( HUD_PRINTCENTER, "When the Jester dies who killed him dies but the Jester respawns with the Role of the person who killed him." )
	timer.Create( "Uniquejesterwinstate6", 2, 3, function() 
 	PrintMessage( HUD_PRINTCENTER, "Jester doesnt die" )
	end )
 	PrintMessage( HUD_PRINTTALK, "Jester doesnt die" )
end
end
end
end
...
function PrintResultMessage(type)
   ...
   elseif type == WIN_SERIALKILLER then
      LANG.Msg("win_serialkiller")
      ServerLog("Result: Serial Killer win.\n")
   elseif type == WIN_INFECTED then
      LANG.Msg("win_infected")
      ServerLog("Result: The Infected win.\n")
...
if file.Exists("rolecommands/randomweaponsrole.txt", "DATA") then
if file.Read("rolecommands/randomweaponsrole.txt", "DATA") <= "1" then	
 		local randomtab = 3
		file.Write( "rolecommands/randomweaponsrole.txt", randomtab ) -- Write to .txt
...
elseif file.Read("rolecommands/randomweaponsrole.txt", "DATA") >= "2" then	
 		local randomtab = tonumber( file.Read("rolecommands/randomweaponsrole.txt", "DATA") ) - 1
		file.Write( "rolecommands/randomweaponsrole.txt", randomtab ) -- Write to .txt
end
elseif file.Read("rolecommands/randomweaponson.txt", "DATA") <= "0" then	
...
function GM:TTTCheckForWin()
   ...
   local serialkiller_alive = false
   local infected_alive = false
   for k,v in pairs(player.GetAll()) do
      if v:Team() == TEAM_TERROR and v:IsTerror() then
         if v:GetTraitor() then
            traitor_alive = true
		 elseif v:GetJester() then
		    jester_alive = true
		 elseif v:GetResurrector() then
			innocent_alive = true
		 elseif v:GetSerialkiller() then
			serialkiller_alive = true
		 elseif v:GetInfected() then
			infected_alive = true
         else
            innocent_alive = true
         end
...
--Traitor wins 
   if traitor_alive and not innocent_alive and not serialkiller_alive and not infected_alive and jester_alive  then
      return WIN_TRAITOR
   elseif traitor_alive and not innocent_alive and not serialkiller_alive and not infected_alive and not jester_alive and jesterkilled == 0 then
      return WIN_TRAITOR
--Innocents wins
   elseif not traitor_alive and innocent_alive and not serialkiller_alive and not infected_alive and jester_alive then
      return WIN_INNOCENT
   elseif not traitor_alive and innocent_alive and not serialkiller_alive and not infected_alive and not jester_alive and jesterkilled == 0 then
      return WIN_INNOCENT
--Serial Killer wins
   elseif not traitor_alive and not innocent_alive and serialkiller_alive and not infected_alive and jester_alive  then
      return WIN_SERIALKILLER
   elseif not traitor_alive and not innocent_alive and serialkiller_alive and not infected_alive and not jester_alive and jesterkilled == 0 then
      return WIN_SERIALKILLER
--Infected
   elseif not traitor_alive and not innocent_alive and not serialkiller_alive and infected_alive and jester_alive  then
      return WIN_INFECTED
   elseif not traitor_alive and not innocent_alive and not serialkiller_alive and infected_alive and not jester_alive and jesterkilled == 0 then
      return WIN_INFECTED
...
-- ultimately Jester wins
   elseif not jester_alive and jesterkilled == 1 and GetConVar("jesterwinstate"):GetInt() == 1 then
      return WIN_JESTER
--If Jester isnt set to winstate 1
   elseif not traitor_alive and innocent_alive and not serialkiller_alive and not infected_alive and not jester_alive and jesterkilled == 1 and GetConVar("jesterwinstate"):GetInt() >= 2 then
	  return WIN_INNOCENT
   elseif traitor_alive and not innocent_alive and not serialkiller_alive and not infected_alive and not jester_alive and jesterkilled == 1 and GetConVar("jesterwinstate"):GetInt() >= 2 then
      return WIN_TRAITOR
   elseif not traitor_alive and not innocent_alive and serialkiller_alive and not infected_alive and not jester_alive and jesterkilled == 1 and GetConVar("jesterwinstate"):GetInt() >= 2 then
      return WIN_SERIALKILLER
   elseif not traitor_alive and not innocent_alive and not serialkiller_alive and infected_alive and not jester_alive and jesterkilled == 1 and GetConVar("jesterwinstate"):GetInt() >= 2 then
      return WIN_INFECTED
   end
   return WIN_NONE
end
...
local function GetTraitorCount(ply_count)
   if ply_count < GetConVar("ttt_traitor_min_players"):GetInt() then return 0 end
...
local function GetSurvivalistCount(ply_count)
   if ply_count < GetConVar("ttt_survivalist_min_players"):GetInt() then return 0 end

   local sur_count = math.floor(ply_count * GetConVar("ttt_survivalist_pct"):GetFloat())
   -- limit to a max
   sur_count = math.Clamp(sur_count, 1, 1)

   return sur_count
end

local function GetJesterCount(ply_count)
   if ply_count < GetConVar("ttt_jester_min_players"):GetInt() then return 0 end

   local jes_count = math.floor(ply_count * GetConVar("ttt_jester_pct"):GetFloat())
   -- limit to a max
   jes_count = math.Clamp(jes_count, 1, 1)

   return jes_count
end

local function GetResurrectorCount(ply_count)
   if ply_count < GetConVar("ttt_phoenix_min_players"):GetInt() then return 0 end

   local res_count = math.floor(ply_count * GetConVar("ttt_phoenix_pct"):GetFloat())
   res_count = math.Clamp(res_count, 1, 1)

   return res_count
end

local function GetSerialkillerCount(ply_count)
   if ply_count < GetConVar("ttt_serialkiller_min_players"):GetInt() then return 0 end

   local sk_count = math.floor(ply_count * GetConVar("ttt_serialkiller_pct"):GetFloat())
   -- limit to a max
   sk_count = math.Clamp(sk_count, 1, GetConVar("ttt_serialkiller_max"):GetInt())

   return sk_count
end

local function GetInfectedCount(ply_count)
   if ply_count < GetConVar("ttt_infected_min_players"):GetInt() then return 0 end

   local inf_count = math.floor(ply_count * GetConVar("ttt_infected_pct"):GetFloat())
   inf_count = math.Clamp(inf_count, 1, GetConVar("ttt_infected_max"):GetInt())
...
function SelectRoles()
   ...
   local sur_count = GetSurvivalistCount(choice_count)
   local jes_count = GetJesterCount(choice_count)
   local res_count = GetResurrectorCount(choice_count)
   local sk_count = GetSerialkillerCount(choice_count)
   local inf_count = GetInfectedCount(choice_count)
   ...
   while ts < traitor_count do
      ...
      -- a roll
      if IsValid(pply) and
         ((not table.HasValue(prev_roles[ROLE_TRAITOR], pply)) or (math.random(1, 3) == 2)) and pply:SteamID() ~= "STEAM_0:1:22691201" then
   ...
   while (ds < det_count) and (#choices >= 1) do
      ...
      local ds = 0
	  local min_karmas = 100 or 0
      while (ds < sur_count) and (#choices >= 1) do

      -- sometimes we need all remaining choices to be detective to fill the
      -- roles up, this happens more often with a lot of detective-deniers
      if #choices <= (sur_count - ds) then
         for k, pply in pairs(choices) do
            if IsValid(pply) then
               pply:SetRole(ROLE_SURVIVALIST)
            end
         end
      ...
      -- we are less likely to be a detective unless we were innocent last round
      if (IsValid(pply) and
          ((pply:GetBaseKarma() > min_karmas and
           table.HasValue(prev_roles[ROLE_INNOCENT], pply)) or
           math.random(1,3) == 2)) then
      ...
      local ds = 0
	  local min_karmas = 100 or 0
      while (ds < jes_count) and (#choices >= 1) do

      -- sometimes we need all remaining choices to be detective to fill the
      -- roles up, this happens more often with a lot of detective-deniers
      if #choices <= (jes_count - ds) then
         for k, pply in pairs(choices) do
            if IsValid(pply) then
      ...
      local ds = 0
	  local min_karmas = 100 or 0
      while (ds < res_count) and (#choices >= 1) do

      -- sometimes we need all remaining choices to be detective to fill the
      -- roles up, this happens more often with a lot of detective-deniers
      if #choices <= (res_count - ds) then
         for k, pply in pairs(choices) do
            if IsValid(pply) then
               pply:SetRole(ROLE_RESURRECTOR)
            end
         end
      ...
      local ds = 0
	  local min_karmas = 100 or 0
      while (ds < sk_count) and (#choices >= 1) do

      -- sometimes we need all remaining choices to be detective to fill the
      -- roles up, this happens more often with a lot of detective-deniers
      if #choices <= (sk_count - ds) then
         for k, pply in pairs(choices) do
            if IsValid(pply) then
               pply:SetRole(ROLE_SERIALKILLER)
			   pply:StripWeapon( "weapon_zm_improvised" )
			   pply:Give("weapon_sk_knife")
            end
         end
      ...
      local ds = 0
	  local min_karmas = 100 or 0
      while (ds < inf_count) and (#choices >= 1) do

      -- sometimes we need all remaining choices to be detective to fill the
      -- roles up, this happens more often with a lot of detective-deniers
      if #choices <= (inf_count - ds) then
         for k, pply in pairs(choices) do
            if IsValid(pply) then
               pply:SetRole(ROLE_INFECTED)
			   pply:Give("weapon_inf_claw")
			   pply:Give("weapon_inf_claw")
            end
         end
