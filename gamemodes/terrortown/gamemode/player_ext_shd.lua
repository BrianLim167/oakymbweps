...
function plymeta:GetSurvivalist() return self:GetRole() == ROLE_SURVIVALIST end
function plymeta:GetJester() return self:GetRole() == ROLE_JESTER end
function plymeta:GetResurrector() return self:GetRole() == ROLE_RESURRECTOR end
function plymeta:GetSerialkiller() return self:GetRole() == ROLE_SERIALKILLER end
function plymeta:GetInfected() return self:GetRole() == ROLE_INFECTED end


plymeta.IsTraitor = plymeta.GetTraitor
plymeta.IsDetective = plymeta.GetDetective
plymeta.IsSurvivalist = plymeta.GetSurvivalist
plymeta.IsJester = plymeta.GetJester
plymeta.IsResurrector = plymeta.GetResurrector
plymeta.IsSerialkiller = plymeta.GetSerialkiller
plymeta.IsInfected = plymeta.GetInfected
...
function plymeta:IsActiveSurvivalist() return self:IsActiveRole(ROLE_SURVIVALIST) end
function plymeta:IsActiveJester() return self:IsActiveRole(ROLE_JESTER) end
function plymeta:IsActiveResurrector() return self:IsActiveRole(ROLE_RESURRECTOR) end
function plymeta:IsActiveSerialkiller() return self:IsActiveRole(ROLE_SERIALKILLER) end
function plymeta:IsActiveInfected() return self:IsActiveRole(ROLE_INFECTED) end
